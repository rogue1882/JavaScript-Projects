...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        //This varib;e retrieves the html eliment id that was clicked.
...
function checkWinConditions() {
    ...
    //squres are selected the code executes.
...
function animateLineDrawing() {
    ...
    c.lineWidth = 10;
    //This line sets the color of our line.
...
function clear() {
    ...
    c.clearRect(0,0,608,608);
    //This loop stops our animation loop.
...
function resetGame() {
    //This for loop iterates through each HTML squaare element.
    for (let i = 0; i < 9; i++) {
